...
const partners: {
...
}[] = [
  {
    ...
    tagline: "Circuit Debate. Available to all.",
  ...
  },
  {
    ...
    tagline: "One of the nation's top programs.",
  ...
  },
  {
    ...
    tagline: "Debate for youth, by youth",
    href: "https://primedebateinstitute.weebly.com/",
    logo: "/logo-pdi.png",
  },
  {
    name: "PepTalk Debate",
    tagline: "Free mentorship for the under-resourced.",
